  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved owner as @owner" do
        ...
        post :create, {:owner => { "first_name" => "invalid value" }}, valid_session
        assigns(:owner).should be_a_new(Owner)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested owner" do
        ...
        Owner.any_instance.should_receive(:update).with({ "first_name" => "MyString" })
        put :update, {:id => owner.to_param, :owner => { "first_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the owner as @owner" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Owner.any_instance.stub(:save).and_return(false)
        put :update, {:id => owner.to_param, :owner => { "first_name" => "invalid value" }}, valid_session
        assigns(:owner).should eq(owner)
      end
